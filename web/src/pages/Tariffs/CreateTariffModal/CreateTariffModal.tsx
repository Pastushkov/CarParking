...
export const CreateTariffModal = ({ isOpened, onBackdropClick, onSubmit }: Props) => {
    ...
    <Modal isOpened={isOpened} onBackdropClick={onBackdropClick} className="w-100 overflow-visible p-6">
      <form onSubmit={handleSubmit(submit)}>
        <div className="flex items-center gap-8">
          <div className="text-lg font-semibold">Create new tariff</div>
